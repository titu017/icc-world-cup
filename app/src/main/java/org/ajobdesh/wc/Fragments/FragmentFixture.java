...
public class FragmentFixture extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listFixture.add(new Fixture("Match 3","1/6/2019", "15:30 (GMT+6)" ,"Cardiff Wales, Cardiff", R.drawable.newzealand , R.drawable.srilanka, "New Zealand", "Sri Lanka"));
        listFixture.add(new Fixture("Match 4","1/6/2019", "18:30 (GMT+6)" ,"Country Ground, Bristol", R.drawable.afghanistan , R.drawable.australia, "Afghanistan", "Australia"));
        ...
        listFixture.add(new Fixture("Match 7","4/6/2019", "15:30 (GMT+6)" ,"Cardiff Wales, Cardiff", R.drawable.afghanistan , R.drawable.srilanka, "Afghanistan", "Sri Lanka"));
        listFixture.add(new Fixture("Match 8","5/6/2019", "15:30 (GMT+6)" ,"Hampshire Bowl", R.drawable.southafrica , R.drawable.india, "South Africa", "India"));
        ...
        listFixture.add(new Fixture("Match 11","7/6/2019", "15:30 (GMT+6)" ,"Country Ground", R.drawable.pakistan , R.drawable.srilanka, "Pakistan", "Sri Lanka"));
        listFixture.add(new Fixture("Match 12","8/6/2019", "15:30 (GMT+6)" ,"Cardiff Wales, Cardiff", R.drawable.england , R.drawable.bangladesh, "England", "Bangladesh"));
        listFixture.add(new Fixture("Match 13","8/6/2019", "18:30 (GMT+6)" ,"County Ground, Taunton", R.drawable.afghanistan , R.drawable.newzealand, "Afghanistan", "New Zealand"));
        ...
        listFixture.add(new Fixture("Match 16","11/6/2019", "15:30 (GMT+6)" ,"County Ground, Bristol", R.drawable.bangladesh , R.drawable.srilanka, "Bangladesh", "Sri Lanka"));
        listFixture.add(new Fixture("Match 17","12/6/2019", "15:30 (GMT+6)" ,"County Ground, Taunton", R.drawable.australia, R.drawable.pakistan, "Australia", "Pakistan"));
        ...
        listFixture.add(new Fixture("Match 19","14/6/2019", "15:30 (GMT+6)" ,"Hampshire Bowl", R.drawable.england , R.drawable.westindies, "England", "West Indies"));
        ...
        listFixture.add(new Fixture("Match 21","15/6/2019", "18:30 (GMT+6)" ,"Cardiff Wales, Cardiff", R.drawable.southafrica , R.drawable.afghanistan, "South Africa", "Afghanistan"));
        ...
        listFixture.add(new Fixture("Match 23","17/6/2019", "15:30 (GMT+6)" ,"County Ground, Taunton", R.drawable.westindies , R.drawable.bangladesh, "West Indies", "Bangladesh"));
        ...
        listFixture.add(new Fixture("Match 28","22/6/2019", "15:30 (GMT+6)" ,"Hampshire Bowl", R.drawable.india , R.drawable.afghanistan, "India", "Afghanistan"));
        ...
        listFixture.add(new Fixture("Match 31","24/6/2019", "15:30 (GMT+6)" ,"Hampshire Bowl", R.drawable.bangladesh , R.drawable.afghanistan, "Bangladesh", "Afghanistan"));
        ...
        listFixture.add(new Fixture("Match 35","28/6/2019", "15:30 (GMT+6)" ,"Durham", R.drawable.srilanka , R.drawable.southafrica, "Sri Lanka", "South Africa"));
        ...
        listFixture.add(new Fixture("Match 39","1/7/2019", "15:30 (GMT+6)" ,"Durham", R.drawable.srilanka , R.drawable.westindies, "Sri Lanka", "West Indies"));
        ...
        listFixture.add(new Fixture("Match 41","3/7/2019", "15:30 (GMT+6)" ,"Durham", R.drawable.england , R.drawable.newzealand, "England", "New Zealand"));
